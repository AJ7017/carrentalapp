...
import 'package:carrentalapp/presentation/pages/MapsDetailsPage.dart';
import 'package:carrentalapp/presentation/pages/RegistrationPage.dart'; // Import the RegistrationPage
...
import 'package:carrentalapp/presentation/pages/BuyingForm.dart';
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BuyingForm(carModel: widget.car.model + "-1", pricePerHour: widget.car.pricePerHour,),
                        ),
                      );
                    },
                    child: MoreCard(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BuyingForm(carModel: widget.car.model + "-2",pricePerHour: widget.car.pricePerHour,),
                        ),
                      );
                    },
                    child: MoreCard(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BuyingForm(carModel: widget.car.model + "-3",pricePerHour: widget.car.pricePerHour,),
                        ),
                      );
                    },
                    child: MoreCard(
